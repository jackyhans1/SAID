...
class AlcoholCNN(nn.Module):
    def __init__(self, num_classes=2):
        ...
        self.layer1 = ResidualBlock(32, 64, stride=2, p_drop=0.3)
        self.layer2 = ResidualBlock(64, 128, stride=2, p_drop=0.3)
        self.layer3 = ResidualBlock(128, 256, stride=2, p_drop=0.3)
        self.layer4 = ResidualBlock(256, 512, stride=2, p_drop=0.3)
        self.layer5 = ResidualBlock(512, 256, stride=2, p_drop=0.3)

        self.conv_final = nn.Conv2d(256, 128, 3, 1, 1, bias=False)

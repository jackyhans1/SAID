...
parser.add_argument("--img_root", default="/data/alc_jihan/morphology_thresholded_95_resized")
parser.add_argument("--ckpt", default="/home/ai/said/dysfluency_cnn95_spon/modeling9/checkpoint/best.pth")
parser.add_argument("--save_dir", default="/home/ai/said/dysfluency_cnn95_spon/modeling9/checkpoint")
